> This file is a mirror of AGENTS.md. The canonical source lives at /AGENTS.md.
> If this file diverges from AGENTS.md, AGENTS.md wins. Update both together
> (CI enforces the diff via .github/workflows/agents-mirror-check.yml).
> Claude Code reads this file as its complete rules; it cannot follow a pointer.
